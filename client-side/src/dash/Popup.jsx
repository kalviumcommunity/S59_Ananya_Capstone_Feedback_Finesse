      ...
      <div className="popup-content" onClick={(e) => e.stopPropagation()}>
        <div className="eachpost">
          ...
          <div className="secondrow">
            <h3 className="flex items-center"><i className='bx bxs-id-card mr-1 text-3xl' style={{ color: "#900000" }}></i>University ID: <span>{indvPost.universityID}</span></h3>
            <h3 className="flex items-center"><i className='bx bxs-building-house mr-1 text-3xl' style={{ color: "#900000" }}></i>Hostel: <span>{indvPost.hostel}</span></h3>
            <h3 className="flex items-center"><i className='bx bxs-book-open mr-1 text-3xl' style={{ color: "#900000" }}></i>Issue: <span>{indvPost.title}</span></h3>
          </div>
            ...
            {indvPost.picture && indvPost.picture.length > 0 && (
              <div className="image-slider-controls flex flex-col w-fit">
                <div className="flex items-center justify-between">
                  <div>
                    <ArrowBackIosIcon
                      className={imageIndex > 0 ? "workingarrow" : "disablearrow"}
                      onClick={handleLeft}
                    />
                  </div>
        ...
        Admin Note: {indvPost.adminNote ? indvPost.adminNote : "NA"}
